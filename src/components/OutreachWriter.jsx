...
export default function OutreachWriter({ leads, updateLead, apiKey, setActive }) {
  ...
  const generateEmail = async (lead, tmpl, context) => {
    ...
    const prompt = `You are writing on behalf of CTD Africa (Connect The Dots Africa), a Pan-African digital marketing agency based in Boksburg, Gauteng, South Africa.
...
- Sign off as CTD Africa team — include email: info@connectthedots.africa and website: ctd-africa.com
    ...
    <div className="page">
      <div className="page-header">
        <div>
          ...
          <p className="page-sub">AI writes personalised outreach emails for CTD Africa — you review and send</p>
        </div>
